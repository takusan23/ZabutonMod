...
public class EntityZabutonBlock extends Entity{
	public int blockPosX;
	public int blockPosY;
	public int blockPosZ;

	public EntityZabutonBlock(World world)
	{
		super(world);
		this.noClip = true;
		this.height = 0.01F;
	...
	public EntityZabutonBlock(World world, double x, double y, double z, double y0ffset)
	{
		this(world);
	...
	public EntityZabutonBlock(World world, double x, double y, double z, double y0ffset, int rotation, double rotationOffset)
	{
		this(world);
		this.blockPosX = (int) x;
		this.blockPosY = (int) y;
