...
public class Kyuusu_Finish_Block extends Block {

	public static final PropertyDirection FACING;

	public Kyuusu_Finish_Block(Material materialIn) {
		super(Material.CIRCUITS);
		setCreativeTab(ZabutonMod.ZabutonModTab);
		setHardness(2.0F);
		setSoundType(blockSoundType.STONE);
		setUnlocalizedName("Kyuusu_Finish_Block");
		setRegistryName("kyuusu_block_finish");
